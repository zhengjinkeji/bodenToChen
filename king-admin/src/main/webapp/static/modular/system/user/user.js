...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '积分', field: 'integral', align: 'center', valign: 'middle', sortable: true},
...
MgrUser.resetPwd = function () {
	var random = MgrUser.random();
    if (this.check()) {
        var userId = this.seItem.id;
        parent.layer.confirm('是否重置密码为:'+random, {
            btn: ['确定', '取消'],
            shade: false //不显示遮罩
        }, function () {
