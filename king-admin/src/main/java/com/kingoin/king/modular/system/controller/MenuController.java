...
import com.kingoin.king.core.common.constant.dictmap.MenuDict;
...
import com.kingoin.king.core.support.BeanKit;
import com.kingoin.king.core.util.ToolUtil;
import com.kingoin.king.modular.system.model.Menu;
import com.kingoin.king.modular.system.service.IMenuService;
import com.kingoin.king.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new KingException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new KingException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
