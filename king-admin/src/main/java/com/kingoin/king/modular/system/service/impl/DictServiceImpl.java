...
import com.kingoin.king.modular.system.dao.DictMapper;
...
import static com.kingoin.king.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new KingException(BizExceptionEnum.DICT_EXISTED);
        }
 ...
 */
    @Override//victor
    public List<Dict> selectByCode(String pid) {
        return this.baseMapper.selectByCode(pid);
    }
