...
Basicinfo.initColumn = function () {
    var columns = [
        ...
        {title: '最低价', field: 'minPrice', align: 'center', valign: 'middle', sortable: true},
        ...
        {title: '积分比', field: 'score', align: 'center', valign: 'middle', sortable: true},
...
Basicinfo.openChange = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/basicinfo/basicinfo_edit_dz/' + this.seItem.id
        });
...
Basicinfo.numSpec = function () {
	if (this.check()) {
	    var index = layer.open({
	        ...
	        fix: false, //不固定
	        maxmin: true,
	        content: Feng.ctxPath + '/basicinfo/num_spec/'+this.seItem.id
	    });
	    this.layerIndex = index;
	  }
};
...
Basicinfo.openAdd = function () {
    ...
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/basicinfo/basicinfo_add_dz'
    });
    this.layerIndex = index;
};
/**
...
$(function () {
    ...
    var table = new BSTable(Basicinfo.id, "/basicinfo/list_dz", defaultColunms);
