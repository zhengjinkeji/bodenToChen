...
Basicinfo.openChange = function () {
    if (this.check()) {
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/basicinfo/basicinfo_edit/' + this.seItem.id
        });
...
Basicinfo.openAdd = function () {
    ...
    var index = layer.open({
        ...
        fix: false, //不固定
        maxmin: true,
        content: Feng.ctxPath + '/basicinfo/basicinfo_add'
    });
    this.layerIndex = index;
};
/**
...
$(function () {
    ...
    var table = new BSTable(Basicinfo.id, "/basicinfo/list", defaultColunms);
